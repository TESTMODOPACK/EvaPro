...
type Tab = 'summary' | 'suggestions' | 'prediction';
        ...
        <div className="card animate-fade-up" style={{ borderLeft: '4px solid var(--accent)', marginBottom: '1.5rem', padding: '1.5rem' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <p style={{ fontSize: '0.78rem', color: 'var(--text-muted)', marginTop: '0.4rem', paddingLeft: '1.25rem' }}>
              {'Las predicciones NO dependen del ciclo seleccionado — utilizan datos históricos de todos los ciclos. No requieren generación con IA ni consumen créditos. Riesgo de Fuga y Retención se encuentran en Análisis de Dotación.'}
            </p>
          </div>
