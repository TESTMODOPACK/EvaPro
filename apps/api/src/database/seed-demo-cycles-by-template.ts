...
// Defaults de pesos por cycle type (alineados con seed-demo-cycles-mix-a.ts
// y con los defaults del backend para form_sub_templates).
const DEFAULT_WEIGHTS: Record<string, Record<string, number>> = {
  '90': { manager: 0.7, self: 0.3 },
  '180': { manager: 0.45, self: 0.25, peer: 0.3 },
  '270': { manager: 0.35, self: 0.2, peer: 0.2, direct_report: 0.25 },
  '360': { manager: 0.3, self: 0.2, peer: 0.25, direct_report: 0.25 },
};
