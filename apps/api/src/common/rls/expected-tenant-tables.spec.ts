...
describe('EXPECTED_TENANT_TABLES baseline', () => {
  it('contiene exactamente 71 tablas con tenant_id (snapshot al 2026-04-28)', () => {
    ...
    // 70 → 71: agregada `cycle_evaluatee_weights` (Sprint 2 BR-A.1).
    expect(EXPECTED_TENANT_TABLES.length).toBe(71);
  });
