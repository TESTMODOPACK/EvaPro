...
mkdir -p "${BACKUP_DIR}"
# F4 RLS NOTA: $POSTGRES_USER (= eva360) es SUPERUSER por default en
# postgres:16-alpine — tiene BYPASSRLS automatico → pg_dump funciona
# correctamente incluso con tablas en FORCE ROW LEVEL SECURITY.
